...
(function () {
	...
	function operateFormatter(value,row,index){
		return ['<a href="javascript:void(0)" class="btn  btn-warning btn-xs replyOrderComment">',
		'回复','</a><button type="button" class="btn  btn-danger btn-xs">',
		'删除','</button>'].join('');
	}
