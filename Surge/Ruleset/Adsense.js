...
if ((url.includes("api-access.pangolin-sdk-toutiao.com/api/ad/union/sdk")
        ...
        || url.includes("is.snssdk.com/api/ad/union/sdk") || url.includes("push.m.youku.com/collect-api/v1/guid_devices") || url.includes("sf3-fe-tos.pglstatp-toutiao.com/obj/ad-pattern/renderer/package.js"))
    && method === postMethod) {
...
} else if (url.includes('mi.gdt.qq.com') || includes('cad.youku.com') || url.includes('huichuan.sm.cn') || url.includes('yk-ssp.ad.youku.com') && method === getMethod) {
    console.log('优量汇');
    if ('ret' in body) {
        if (body.ret === 0) {
