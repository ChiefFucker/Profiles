...
if ((url.includes("api-access.pangolin-sdk-toutiao.com/api/ad/union/sdk")
        ...
        || url.includes("is.snssdk.com/api/ad/union/sdk") || url.includes("sf3-fe-tos.pglstatp-toutiao.com/obj/ad-pattern/renderer/package.js") || url.includes("mon.zijieapi.com/monitor/collect/c/cloudcontrol/get"))
    && method === postMethod) {
...
} else if (url.includes('mi.gdt.qq.com') || url.includes('nbsdk-baichuan.alicdn.com') || url.includes('huichuan.sm.cn/v') || url.includes('huichuan-mc.sm.cn/v') && method === getMethod) {
    console.log('优量汇');
    if ('ret' in body) {
        if (body.ret === 0) {
