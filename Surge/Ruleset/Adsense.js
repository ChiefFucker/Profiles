...
} else if (url.includes('mi.gdt.qq.com') || url.includes('yk-ssp.ad.youku.com') || url.includes('huichuan.sm.cn') || url.includes('huichuan-mc.sm.cn') || url.includes('lf-cdn-tos.bytescm.com/obj/static/ad/play-comp') && method === getMethod) {
    console.log('优量汇');
    if ('ret' in body) {
        if (body.ret === 0) {
